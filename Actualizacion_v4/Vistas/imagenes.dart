...
import 'package:clase2857/MisWidgets/packWidgets.dart';
...
class _ImagenesState extends State<Imagenes> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
      /* // ASI SE USA EL WIDGET DE IMAGEN CLICKEABLE
      ListView( // asi se hace una lista para acomodar los objetos
        children: [
      ...
      */
      ...
      // ASI SE HACE EL WIDGET DE LISTA DE IMAGENES CON DESCRIPCIONES
      ListaImagen(
        rutas: ["gato/gato1.jpg","gato/spiderman1.jpg"],
        descripciones: ["Soy un gato","Soy spiderman"]
      ),
    );
  }
